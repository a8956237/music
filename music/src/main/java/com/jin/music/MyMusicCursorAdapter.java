...
public class MyMusicCursorAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        viewHolder.mImageView = view.findViewById(R.id.image_view);
        viewHolder.mTitleTextView = view.findViewById(R.id.title_text_view);
        viewHolder.mArtistTextView = view.findViewById(R.id.artist_text_view);
